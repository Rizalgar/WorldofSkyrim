...
ObjectReference Property HumanMarker Auto
...
Spell Property Wow_Spell_Fireball Auto
Spell Property Wow_Spell_Hearth Auto
Spell Property Wow_Summon_HorseBlack Auto
			...
			Int Class1 = Wow_M_ClassSelect.Show()
				...
				ElseIf Class1 == 4
					...
					ElseIf Class2 == 2
						...
						Wow_Level_1.SetValue(1)
						Game.GetPlayer().AddSpell(Wow_Spell_Fireball)
						Game.GetPlayer().AddSpell(Wow_Spell_Hearth)
						Game.GetPlayer().AddSpell(Wow_Summon_HorseBlack)
					ElseIf Class2 == 3
